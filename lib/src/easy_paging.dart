...
/// Paging item builder.
typedef EasyPagingItemBuilder<ItemType> =
    Widget Function(BuildContext context, int index, ItemType item);
...
abstract class EasyPagingState<DataType, ItemType> extends State<EasyPaging> {
  ...
  Widget buildScrollView([ScrollPhysics? physics]) {
    return CustomScrollView(physics: physics, slivers: buildSlivers());
  }
