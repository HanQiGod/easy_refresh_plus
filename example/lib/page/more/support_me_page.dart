...
class _SupportMePageState extends State<SupportMePage> {
  static const String _alipayChannel =
      "com.codiss.easy.refresh.plus.example/channel";
          ...
          SliverList(
            delegate: SliverChildListDelegate([
              ListItem(
                title: 'Star Github',
                subtitle:
                    'https://github.com/xuelongqy/easy_refresh_plus',
              ...
              ListItem(
                title: 'Pub Like',
                subtitle: 'https://pub.dev/packages/easy_refresh_plus',
                iconPaths: PathIcons.dart,
                onTap: () {
                  launchUrl(
                    Uri.parse(
                      'https://pub.dev/packages/easy_refresh_plus',
                    ),
                  );
                },
              ),
